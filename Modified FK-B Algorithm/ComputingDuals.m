...
%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
%
% This script computes dual of dnfs using different methods.
clear all
...
for nn=1:numel(models)
    ...
    rng(6)
    [R_cnf, R_cpu, R_len]= FK_Dualization_R(dnf, 1);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    rng(6)
    [MHR0_cnf, MHR0_cpu, MHR0_len]= FK_Dualization_MHR(dnf, 1, 0);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    rng(6)
    [MHR3_cnf, MHR3_cpu, MHR3_len]= FK_Dualization_MHR(dnf, 1, 3);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    rng(6)
    [MHCR0_cnf, MHCR0_cpu, MHCR0_len]= FK_Dualization_MHCR(dnf, 1, 0);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    rng(6)
    [MHCR3_cnf, MHCR3_cpu, MHCR3_len]= FK_Dualization_MHCR(dnf, 1, 3);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     cnf = MHR3_cnf;
%     dnf = save_dnf;
%     save(strcat(model, '_CNF_DNF.mat'), 'cnf' , 'dnf')
end
